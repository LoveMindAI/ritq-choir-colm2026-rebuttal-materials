...
This repository is intentionally small. It does not include the full extraction, embedding, and codebook outputs or working materials. The files here are the reviewer-facing materials needed to evaluate the specific rebuttal additions.
