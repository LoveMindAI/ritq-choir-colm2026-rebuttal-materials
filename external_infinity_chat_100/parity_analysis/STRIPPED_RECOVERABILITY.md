...
Companion check: `STRIPPED_WITHIN_MODEL_PERSONA_RECOVERABILITY.md` reruns the within-model persona classifier after the same profile-proximate stripping. Accuracy decreases from 0.323 to 0.318, 0.303, and 0.284 under the `< 0.5`, `< 0.4`, and `< 0.3` thresholds, respectively, while remaining above five-way chance.
